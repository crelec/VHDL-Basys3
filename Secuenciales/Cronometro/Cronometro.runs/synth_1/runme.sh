...
HD_PWD='C:/Repo-Asus/VHDL-Basys3/Secuenciales/Cronometro/Cronometro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopCronometro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopCronometro.tcl
