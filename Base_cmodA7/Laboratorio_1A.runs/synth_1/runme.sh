...
HD_PWD='C:/Repo-Asus/VHDL-Basys3-Privado-2024/Base_cmodA7/Laboratorio_1A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Combinacional.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Combinacional.tcl
