...
HD_PWD='C:/Repo-Asus/VHDL-Basys3-Privado-2024/Base_cmodA7/Laboratorio_1A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Combinacional.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Combinacional.tcl -notrace
