...
HD_PWD='C:/Repo-Asus/VHDL-Basys3/Aplicaciones/cronometroV2/cronometro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopCronometro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopCronometro.tcl -notrace
