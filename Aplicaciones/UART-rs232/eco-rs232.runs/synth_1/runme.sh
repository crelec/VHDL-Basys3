...
HD_PWD='C:/Repo-Asus/UART-rs232/eco-rs232.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RS232.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_RS232.tcl
