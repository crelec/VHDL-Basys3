...
HD_PWD='C:/Repo-Asus/VHDL-Basys3/Aplicaciones/UART-rs232/eco-rs232.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RS232.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_RS232.tcl -notrace
