...
HD_PWD='C:/ExpendioDisplay/ExpendioDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log supExpende.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source supExpende.tcl -notrace
