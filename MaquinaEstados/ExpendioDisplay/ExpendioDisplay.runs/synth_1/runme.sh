...
HD_PWD='C:/ExpendioDisplay/ExpendioDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log supExpende.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source supExpende.tcl
