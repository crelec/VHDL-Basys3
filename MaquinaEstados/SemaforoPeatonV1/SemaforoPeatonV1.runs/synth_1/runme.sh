...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/MaquinaEstados/SemaforoPeatonV1/SemaforoPeatonV1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopSemaforo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopSemaforo.tcl
