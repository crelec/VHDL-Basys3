...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/MaquinaEstados/SemaforoPeatonV1/SemaforoPeatonV1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopSemaforo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopSemaforo.tcl -notrace
