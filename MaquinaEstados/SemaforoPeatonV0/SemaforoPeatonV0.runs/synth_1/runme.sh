...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/MaquinaEstados/SemaforoPeatonV0/SemaforoPeatonV0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Superior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Superior.tcl
