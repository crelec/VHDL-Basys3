...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/MaquinaEstados/SemaforoPeatonV0/SemaforoPeatonV0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Superior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Superior.tcl -notrace
