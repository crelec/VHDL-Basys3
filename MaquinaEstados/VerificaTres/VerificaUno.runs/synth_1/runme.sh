...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/MaquinaEstados/VerificaTres/VerificaUno.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SuperiorVerifica.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SuperiorVerifica.tcl
