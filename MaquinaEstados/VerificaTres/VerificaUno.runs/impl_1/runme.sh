...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/MaquinaEstados/VerificaTres/VerificaUno.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SuperiorVerifica.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SuperiorVerifica.tcl -notrace
