...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/Aritmeticos/AbacoSinsigno/AbacoSinsigno.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SupAbaco.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SupAbaco.tcl -notrace
