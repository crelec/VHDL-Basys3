...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/Aritmeticos/AbacoBasico/AbacoBasico.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Operaciones.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Operaciones.tcl
