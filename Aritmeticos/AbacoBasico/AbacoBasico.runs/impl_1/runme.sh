...
HD_PWD='D:/Repo-Lenovo/VHDL-Basys3/Aritmeticos/AbacoBasico/AbacoBasico.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Operaciones.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Operaciones.tcl -notrace
